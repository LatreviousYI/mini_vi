...
func daemonStart() {
	...
	stdout, err := os.OpenFile(filepath.Join(basePath, "server.log"), os.O_WRONLY|os.O_APPEND|os.O_CREATE, 0o666)
	if err != nil {
...
func ServerExit() {
	...
	defer cancel()
	if err := factory.FiberApp.ShutdownWithContext(ctx); err != nil {
